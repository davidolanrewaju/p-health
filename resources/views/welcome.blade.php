<x-layout>
	...
	<div class="flex h-full min-h-screen w-full items-center justify-center bg-slate-100">
		<div class="w-full px-4 text-center md:w-8/12 lg:w-5/12">
			<h1 class="text-4xl font-extralight text-slate-900 md:text-6xl">Welcome to <span class="font-extrabold text-green-500">UniJOS</span> <span class="font-light text-zinc-500">Health</span>!</h1>
